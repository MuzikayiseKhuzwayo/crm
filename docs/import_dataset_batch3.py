...
json_filename = 'dataset_linkedin-profile-search_2026-08-28_00-19-58-397.json'

with open(json_filename, 'r', encoding='utf-8') as f:
    profiles = json.load(f)

print(f"Loaded {len(profiles)} profiles from {json_filename}.")
...
$jsonFile = __DIR__ . '/dataset_batch3.json';
...
foreach ($profiles as $p) {
    ...
    // Deal estimation
    $amount = 6500.00;
    if (preg_match('/trading|hedge|capital|director|founder|vp|head|ceo|cto|cfo|partner|investor/i', $companyName . ' ' . $headline)) {
        $amount = 12500.00;
    } elseif (preg_match('/intern|assistant|analyst|associate|coordinator/i', $jobPos)) {
        $amount = 3500.00;
    }
...
with open('docs/import_dataset_batch3.php', 'w', encoding='utf-8') as out_f:
    out_f.write(php_script)

print("Generated docs/import_dataset_batch3.php successfully.")
